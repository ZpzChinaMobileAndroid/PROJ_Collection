...
//	private int headContentWidth;
	...
	private void init(Context context) {
		...
		headView = (LinearLayout) inflater.inflate(R.layout.listview_headview, null);
		View view = inflater.inflate(R.layout.listview_footview, null);
...
//		this.addFooterView(footerView);
		footerView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(refreshListener!=null && !isScroll){
					setMoreProgressBar(View.VISIBLE);
...
//		headContentWidth = headView.getMeasuredWidth();
	...
	public void onScroll(AbsListView arg0, int firstVisiableItem, int arg2,
		...
		if(isScroll){
			lastItemIndex = arg3 - visibleItemCount;
			if(lastItemIndex!=0 && firstItemIndex == lastItemIndex && getFooterViewsCount() > 0 && !isLoadMore){
	...
	public void onRefreshComplete() {
		setMoreProgressBar(View.INVISIBLE);
		state = DONE;
		lastUpdatedTextView.setText(getResources().getString(R.string.updating) + sdf.format(new Date()));//new Date().toLocaleString()
		changeHeaderViewByState();
		invalidateViews();
	}

	public void onLoadMoreComplete() {
		setMoreProgressBar(View.GONE);
		isLoadMore = false;
	}
	...
	public void setMoreProgressBar(int mVisibility){
		moreProgressBar.setVisibility(mVisibility);
	}
